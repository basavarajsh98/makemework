...
from page_objects.Confirmation_Page import Confirmation_Page
...
class PageFactory():
    ...
    def get_page_object(page_name,base_url='http://weathershopper.pythonanywhere.com/',trailing_slash_flag=True):
        ...
        elif page_name in ["payment"]:
            test_obj = Payment_Page()
        elif page_name in ["confirmation","checkout"]:
            test_obj = Confirmation_Page(base_url=base_url,trailing_slash_flag=trailing_slash_flag)
        return test_obj
